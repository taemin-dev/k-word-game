...
function Tutorial() {
  return (
    <div className={styles.container}>
      ...
      <TutorialBox
        title="고유어와 한자어"
        desc="예부터 우리말에 있었거나우리말에 기초하여 새로 만들어진 말을 '고유어'라고 한다. 그리고 한자에 기초하여 만들어진 말을 한자어라고 한다."
        page={1}
      />
      ...
      <TutorialBox
        title="라운드"
        desc="총 5라운드까지 있으며, 단어를 한 개 맞출 때마다 다음 라운드로 올라간다. 단, 틀릴 경우 이전 라운드로 내려간다. 5번째 라운드의 문제까지 맞추면 성공이고, 단어가 다 떨어질때까지 성공하지 못하면 실패이다."
        page={3}
      />
    </div>
  );
